...
Don't miss this opportunity to connect with industry leaders, discover innovative solutions, and position your business for success in the evolving payments landscape.
    ...
    speakers: [
      ...
      },
      {
        ...
        bio: "Michael leads PayFlow's technical vision and has built payment infrastructure serving millions of transactions.",
      },
      {
    ...
    speakers: [
      {
        ...
        bio: "Emily leads PayFlow's security initiatives and has extensive experience in payment compliance.",
      },
    ],
    agenda: [
      {
    ...
    speakers: [
      {
        ...
        bio: "Maria leads PayFlow's global expansion efforts and has extensive experience in international payments.",
      },
      {
        name: "David Kim",
